...
object LinearRegression extends App{
  ...
  val data = spark.read.option("header","true").option("inferSchema","true").format("csv").load("/Users/Clean-USA-Housing.csv")
  data.printSchema()
  ...
  //val df = data.select(data("Price").as("label"),data("Avg Area Income"),$"Avg Area House Age",$"Avg Area Number of Rooms",$"Area Population")
